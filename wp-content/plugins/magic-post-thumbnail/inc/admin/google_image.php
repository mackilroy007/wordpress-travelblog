...
<tr valign="top">
	...
	<td>
		<input type="text" name="MPT_plugin_banks_settings[googleimage][cxid]" value="<?php echo( isset( $options['googleimage']['cxid'] ) && !empty( $options['googleimage']['cxid'] ) )? $options['googleimage']['cxid']: ''; ?>" >
	</td>
</tr>
<tr valign="top">
	<th scope="row">
	...
	<td>
		<input type="text" name="MPT_plugin_banks_settings[googleimage][apikey]" value="<?php echo( isset( $options['googleimage']['apikey'] ) && !empty( $options['googleimage']['apikey']) )? $options['googleimage']['apikey']: ''; ?>" >
	</td>
</tr>
...
<tr valign="top">
	...
	<td>
		<select name="MPT_plugin_banks_settings[googleimage][search_country]" >
			<?php
...
<tr valign="top">
	...
	<td>
		<select name="MPT_plugin_banks_settings[googleimage][img_color]" >
			<?php
...
<tr valign="top">
	...
	<td>
		<select name="MPT_plugin_banks_settings[googleimage][filetype]" >
			<?php
	...
	<td>
		...
		<?php 
			...
			foreach ( $rights_array  as $right => $right_code ) {
				...
				echo '<label>
					<input '. $checked .' name="MPT_plugin_banks_settings[googleimage][rights]['. $right_code .']" type="checkbox" value="'. $right_code .'"> '. $right .'
				</label><br/>';
			}
		?>
...
<tr valign="top">
	...
	<td>
		<select name="MPT_plugin_banks_settings[googleimage][imgsz]" >
			<?php
...
<tr valign="top">
	...
	<td>
		<select name="MPT_plugin_banks_settings[googleimage][imgtype]" >
			<?php
...
<tr valign="top">
	...
	<td>
		<select name="MPT_plugin_banks_settings[googleimage][safe]" >
			<?php
